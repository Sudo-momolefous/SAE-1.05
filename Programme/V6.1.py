# -*- coding: utf-8 -*-
"""
Analyse de trafic réseau TCPDump
- Extraction des IP source
- Comptage des requêtes
- Détection des IP suspectes (menaces)
- Affichage Tkinter + dashboard HTML interactif
"""
...
section {{ background:#020617; margin:20px; padding:20px; border-radius:12px; }}
.chart-small {{ max-width:500px; max-height:400px; margin:auto; }}
.alert {{ background:#7f1d1d; padding:10px; border-radius:6px; margin-top:6px; }}
table {{ width:100%; border-collapse:collapse; margin-top:10px; }}
th,td {{ border:1px solid #334155; padding:8px; text-align:center; }}
th {{ background:#1e293b; }}
.grid {{ display:grid; grid-template-columns:1fr 1fr; gap:20px; justify-items:center; }}
